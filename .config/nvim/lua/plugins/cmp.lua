		...
		mapping = {
			...
			["<Esc>"] = cmp.mapping(function()
				if not cmp.abort() then
					vim.api.nvim_feedkeys("\03", "n", false)
				end
			end, { "i", "c" }),
			["<CR>"] = cmp.mapping({
...
M = {
	M,
	{ "kdheepak/cmp-latex-symbols", ft = { "markdown", "tex" }, dependencies = "nvim-cmp" },
	{ "chrisgrieser/cmp-nerdfont", ft = { "markdown", "tex", "lua" }, dependencies = "nvim-cmp" },
}
return M
